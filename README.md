...
If you have an Azure account, you can ask to join the wait list for the private preview of Cosmos DB Query Copilot by reaching out to: cdbquerycopilot@microsoft.com.
